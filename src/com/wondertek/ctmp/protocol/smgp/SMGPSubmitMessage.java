...
import com.wondertek.ctmp.protocol.smgp.tlv.TLVByte;
import com.wondertek.ctmp.protocol.smgp.tlv.TLVString;
...
public class SMGPSubmitMessage extends SMGPBaseMessage {
	...
	public String toString() {
		...
		buffer.append("tpPid=").append(this.getTpPid()).append(",");
		buffer.append("tpUdhi=").append(this.getTpUdhi()).append(",");
		buffer.append("pkTotal=").append(this.getPkTotal()).append(",");
		buffer.append("pkNumber=").append(this.getPkNumber()).append(",");
